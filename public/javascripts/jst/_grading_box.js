...
function program1(depth0,data) {
  ...
  foundHelper = helpers.submission;
  stack1 = foundHelper || depth0.submission;
...
function program9(depth0,data) {
  ...
  foundHelper = helpers.assignment_grading_type_is_points;
  stack1 = foundHelper || depth0.assignment_grading_type_is_points;
  stack2 = helpers['if'];
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n";
  foundHelper = helpers.assignment_grading_type_is_percent;
  stack1 = foundHelper || depth0.assignment_grading_type_is_percent;
  stack2 = helpers['if'];
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n";
  foundHelper = helpers.assignment_grading_type_is_letter_grade;
  stack1 = foundHelper || depth0.assignment_grading_type_is_letter_grade;
  stack2 = helpers['if'];
  ...
  if(stack1 || stack1 === 0) { buffer += stack1; }
  buffer += "\n";
  foundHelper = helpers.assignment_grading_type_is_pass_fail;
  stack1 = foundHelper || depth0.assignment_grading_type_is_pass_fail;
  stack2 = helpers['if'];
