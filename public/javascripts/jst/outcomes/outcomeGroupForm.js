define('jst/outcomes/outcomeGroupForm', ["compiled/handlebars_helpers","i18n!outcomes.outcome_group_form"], function (Handlebars) {
  ...
  buffer += escapeExpression(stack1) + "\" class=\"outcome_group\" method=\"post\">\n  <label for=\"outcome_group_title\">";
  stack1 = "Name this group";
  stack2 = "title";
  stack3 = {};
  stack4 = "outcomes.outcome_group_form";
  stack3['scope'] = stack4;
  ...
  stack1 = "Describe this group";
  stack2 = "group_description";
  stack3 = {};
  stack4 = "outcomes.outcome_group_form";
  stack3['scope'] = stack4;
  foundHelper = helpers['t'];
