...
function program1(depth0,data) {
  ...
  foundHelper = helpers.middleScore;
  stack1 = foundHelper || depth0.middleScore;
  if(typeof stack1 === functionType) { stack1 = stack1.call(depth0, { hash: {} }); }
  else if(stack1=== undef) { stack1 = helperMissing.call(depth0, "middleScore", { hash: {} }); }
  buffer += escapeExpression(stack1) + "\"/>\n    ";
  foundHelper = helpers.showOutOf;
  stack1 = foundHelper || depth0.showOutOf;
  stack2 = helpers['if'];
  ...
  stack1 = "Grade curving cannot be undone. Pre-curved grade histories will be available, but the curving action is irreversible.";
  stack2 = "this_is_permanent";
  stack3 = {};
  stack4 = "curve_grades_dialog";
  stack3['scope'] = stack4;
  foundHelper = helpers['t'];
