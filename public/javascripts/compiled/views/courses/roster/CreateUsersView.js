(function() {
  ...
  define(['compiled/models/CreateUserList', 'underscore', 'i18n!create_users_view', 'compiled/views/DialogFormView', 'jst/courses/roster/createUsers', 'jst/courses/roster/createUsersWrapper', 'vendor/jquery.placeholder'], function(CreateUserList, _, I18n, DialogFormView, template, wrapper) {
