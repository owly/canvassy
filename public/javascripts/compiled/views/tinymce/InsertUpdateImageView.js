        ...
        switch (ui.panel.id) {
          case 'tabUploaded':
            return loadTab(function(done) {
              return require(['compiled/views/FileBrowserView', 'compiled/util/mimeClass'], function(FileBrowserView, mimeClass) {
                var contentTypes;

                contentTypes = _.compact(_.map(mimeClass.mimeClasses, function(val, key) {
                  if (val === 'image') {
                    return key;
                  }
                }));
